...
public class CursomcApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Categoria cat3 = new Categoria(null, "Informatica 2");
		Categoria cat4 = new Categoria(null, "Escritorio 2" );
		Categoria cat5 = new Categoria(null, "Informatica 3");
		Categoria cat6 = new Categoria(null, "Escritorio 3");
		Categoria cat7 = new Categoria(null, "Informatica 4");
		Categoria cat8 = new Categoria(null, "Escritorio 4");
